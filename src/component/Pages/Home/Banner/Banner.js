  ...
  return (
    <Carousel style={{marginBottom: '80px'}}>
      <Carousel.Item interval={1000}>
        <img className="d-block w-100 vh-100" src={BannerImage1} alt="First slide" />
        <Carousel.Caption>
          <h3> IELTS Class</h3>
      ...
      <Carousel.Item interval={500}>
        <img className="d-block w-100 vh-100" src={BannerImage2} alt="Second slide" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className="d-block w-100 vh-100" src={BannerImage3} alt="Third slide" />
        <Carousel.Caption>
